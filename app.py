...
def create_data_model(distance_type, custom_demands=None, custom_pickups=None):
    ...
    # Base coordinates (NYC) and generate nearby locations
    base_lat, base_lon = 40.7128, -74.0060
    np.random.seed(42)
    num_locations = 28
    ...
    locations = [(base_lat, base_lon)]  # Depot
    locations.extend([(base_lat + lat_offset, base_lon + lon_offset)
...
def main():
    ...
    # Create main tabs
    tabs = st.tabs(["Customer Data Input", "Vehicle Configuration", "Route Optimization"])
